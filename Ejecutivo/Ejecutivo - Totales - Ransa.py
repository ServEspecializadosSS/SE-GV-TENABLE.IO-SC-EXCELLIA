...
def cant_vuln(tabla,segmento,fecha_inicial,final_date,severity):
    ...
    ('Ransa Perú','Ransa Guatemala','Ransa Honduras','Ransa El Salvador','Ransa EEUU',
    'Ransa Colombia','Ransa Total','Ransa Bolivia','Ransa Ecuador','Ransa')
	;"""
...
if __name__ == '__main__':
    ...
    try:
        ...
        VALUES 
        ('{fecha}','Ransa Total','Servidores','Alta',{A[0]},{B[0]},{C[0]},{D[0]});"""
        ...
        cant_obsoletos, cant_remediadas, equipos_escaneados)
        VALUES 
        ('{fecha}','Ransa Total','Servidores','Critica',{A[0]},{B[0]},{C[0]},{D[0]});"""
        cur.execute(query_insert)
        conexion.commit()
        ...
        cant_obsoletos, cant_remediadas, equipos_escaneados)
        VALUES 
        ('{fecha}','Ransa Total','Estaciones de Trabajo','Alta',{A[0]},{B[0]},{C[0]},{D[0]});"""
        cur.execute(query_insert)
        conexion.commit()
        ...
        cant_obsoletos, cant_remediadas, equipos_escaneados)
        VALUES 
        ('{fecha}','Ransa Total','Estaciones de Trabajo','Critica',{A[0]},{B[0]},{C[0]},{D[0]});"""
        cur.execute(query_insert)
        conexion.commit()
        ...
        cant_obsoletos, cant_remediadas, equipos_escaneados)
        VALUES 
        ('{fecha}','Ransa Total','Equipos de Comunicación','Alta',{A[0]},{B[0]},{C[0]},{D[0]});"""
        cur.execute(query_insert)
        conexion.commit()
        ...
        cant_obsoletos, cant_remediadas, equipos_escaneados)
        VALUES 
        ('{fecha}','Ransa Total','Equipos de Comunicación','Critica',{A[0]},{B[0]},{C[0]},{D[0]});"""
        cur.execute(query_insert)
        conexion.commit()
